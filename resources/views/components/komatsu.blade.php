...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assets/css/komatsu.css') }}">
    <style>
...
<body>
    <div class="contain">
        <div class="cont2">
            <img src="{{ asset('assets/images/kmbg.jpg') }}" alt="Komatsu" class="komatsu">
            <div class="textleft contentslidein">
                <p class="texthead">KOMATSU</p>
                <hr class="hr">
                <a href="https://utconnect.unitedtractors.com/PartOnlineTransaction/Catalog/KOMATSU" class="href">
