...
<body>
    <div class="contain">
        <div class="cont2">
            <img src="{{ asset('assets/images/scania.png') }}" alt="bomag" class="bomag">
            <div class="textleft contentslidein">
                <p class="texthead">SCANIA</p>
                <hr class="hr">
                <a href="https://utconnect.unitedtractors.com/PartOnlineTransaction/Catalog/SCANIA" class="href">
