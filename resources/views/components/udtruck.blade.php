...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assets/css/bomag.css') }}">
    <style>
...
<body>
    <div class="contain">
        <div class="cont2">
            <img src="{{ asset('assets/images/udtruck.jpg') }}" alt="bomag" class="bomag">
            <div class="textleft contentslidein">
                <p class="texthead">UD TRUCKS</p>
                <hr class="hr">
                <a href="https://utconnect.unitedtractors.com/PartOnlineTransaction/Catalog/UDTRUCKS" class="href">
