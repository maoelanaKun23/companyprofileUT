...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assets/css/tadano.css') }}">
    <style>
...
<body>
    <div class="contain">
        <div class="cont2">
            <img src="{{ asset('assets/images/tada.jpg') }}" alt="bomag" class="bomag">
            <div class="textleft contentslidein">
                <p class="texthead">TADANO</p>
                <hr class="hr">
                <a href="https://utconnect.unitedtractors.com/PartOnlineTransaction/Catalog/TADANO" class="href">
